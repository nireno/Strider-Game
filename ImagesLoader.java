...
/* The Imagesfile and images are stored in "Images/"
   ...
   ImagesFile Formats:
    ...
    o <fileName>                     // a single image file

    n <fileName*.ext> <number>       // a series of numbered image files, whose
                                // filenames use the numbers 0 - <number>-1

    s <fileName> <number>            // a strip file (fileName) containing a single row
                                // of <number> images

    g <name> <fileName> [ <fileName> ]*   // a group of files with different names;
                                // they are accessible via  
                                // <name> and position _or_ <fileName> prefix

    and blank lines and comment lines.

    The numbered image files (n) can be accessed by the <fileName> prefix
    and <number>. 

    The strip file images can be accessed by the <fileName>
    ...
    <fileName> prefix of the particular file, or its position in the group.
...
public class ImagesLoader
{
  ...
  // begin by loading the images specified in fileName
  { initLoader();
  ...
  /* Formats:
        ...
        n <fileName*.ext> <number>       // a numbered sequence of images
        s <fileName> <number>            // an images strip
        g <name> <fileName> [ <fileName> ]*   // a group of images
  ...
  */
  ...
  /*  Can be called directly.
      fileName is the filename argument in:
           n <f*.ext> <number>
  */
  {
    String prefix = null;
    ...
    else {   // treat the fileName as prefix + "*" + postfix
  ...
  */
  ...
  /* Can be called directly, to load a strip file, <fileName>,
  ...
  */
  ...
  /* Extract the individual images from the strip image file, <fileName>.
