...
public class Kaiser extends Enemy
{
	...
	public Kaiser(float xPos, float yPos, Game game, BricksManager bricksMgr, RibbonsManager ribbonsMgr)
	{
		super(xPos, yPos, game);
		sprite = new Sprite((int) xPos, (int) yPos, game.getWidth(), game.getHeight(), game.getImgLdr(), "kaiserL1");
