 ...
 * @author Who
 */
public class Rabit extends Enemy {
private boolean landed;
	public Rabit(float xPos, float yPos, Game game, BricksManager bricksMgr, RibbonsManager ribbonsMgr)
	{
		super(xPos, yPos, game);
		sprite = new Sprite((int) xPos, (int) yPos, game.getWidth(), game.getHeight(), game.getImgLdr(), "rabit");
